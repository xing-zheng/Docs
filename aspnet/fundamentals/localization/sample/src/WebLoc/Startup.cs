...
public void ConfigureServices(IServiceCollection services)
{
            ...
            //     services.AddTransient<IStringLocalizerFactory,  stringLocalizerFactory.Create("Test", location: null) > ();
    ...
    ILoggerFactory loggerFactory, IStringLocalizer<Startup> SR)
{
    ...
    app.UseRequestLocalization(options, defaultRequestCulture: new RequestCulture("es-ES"));
